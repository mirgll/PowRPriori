...
Another useful aspect to investigate is whether the data our simulation produced looks plausible or conforms to our initial intention. We can then call the `plot_sim_model` function with `type = "data"` to plot sample data from our `PowRPriori` object.
